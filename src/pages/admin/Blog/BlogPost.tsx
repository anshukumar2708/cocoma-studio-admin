...
import { BlogPostForm } from "@/components/admin/forms/Blog/BlogPostForm";
...
export default function BlogPost() {
    const [filteredData, setFilteredData] = useState<IBlogItem[]>(workItemData);
    const [currentPage, setCurrentPage] = useState(1);
    const [isFormOpen, setIsFormOpen] = useState(false);
    const [editingItem, setEditingItem] = useState<IBlogItem | null>(null);
    ...
    const columns: Column<IBlogItem>[] = [
        {
            key: "title",
            label: "Title",
            sortable: true,
